Below is an example report document for a new feature in a medium complexity n-tiered Java application with a database backend, used as a customer ticketing system.
